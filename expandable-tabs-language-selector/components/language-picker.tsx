...
export function LanguagePicker({ value, onChange, showLabel = false, className }: LanguagePickerProps) {
  ...
  return (
    <div className={cn("flex items-center", className)}>
      <div
        className={cn(
          "inline-flex gap-1 p-1.5 rounded-2xl border border-border/50 min-w-[320px]",
